    ...
    <div class="location">
        ...
        <div class="locBox">
            <p>
                ...
                <a target="_blank" class="address" href="//www.google.com/maps/place/75+Arlington+St,+Boston,+MA+02116">
                    75 Arlington St<br>
                    Boston, MA 02116
                </a>
            </p>
            <p>
                ...
                <a class="phone" href="tel:617-474-8833">(617)-474-8833</a>
            </p>
            <div class="hours">
                <h2>Hours</h2>
            ...
            <h2><a href="<?php print $rootFolder; ?>/menu/boston.php" target="_blank"> Menu </a></h2>
        </div>
    </div>
